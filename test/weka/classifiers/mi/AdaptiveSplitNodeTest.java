...
public class AdaptiveSplitNodeTest extends AdaptiveSplitTest
{
    ...
    private static void assertNodeEquals(SplitNode actNode, int expSplitAttrIndex, int expSplitPt, int expNodeCount,
                                         SplitNode expLeft, SplitNode expRight)
    {
        ...
        assertEquals("nodeCount", expNodeCount, actNode.nodeCount);
    ...
    {
        assertNodeEquals(node, -1, 0, 1, null, null);
    }
    ...
    {
        assertNodeIsALeaf(new SplitNode(null, null, 0, 0, null, 999, null));
        assertNodeIsALeaf(new SplitNode(null, null, -1, 0, null, 999, null));
        assertNodeIsALeaf(new SplitNode(null, null, -190, 0, null, 999, null));
    }

    @Test
    public void ShouldBeALeafWhenMinCapacityIsNotMet()
    {
        assertNodeIsALeaf(new SplitNode(null, null, 999, 5, new BitSet(), 4, null));
        assertNodeIsALeaf(new SplitNode(null, null, 999, 5, new BitSet(), 0, null));
        assertNodeIsALeaf(new SplitNode(null, null, 999, 2, new BitSet(), 1, null));
    }
    ...
    public void TestPropositionalisationOfOneLevelSplitNode()
    {
        ...
        final SplitNode node = new SplitNode(0, 1, splitPoint, createLeafNode(1), createLeafNode(2), 3);
        assertDatasetEquals(convertToDataset(4, expStrs), SplitNode.propositionaliseDataset(miData, node));
    }
    ...
    public void TestPropositionalisationOfMultiLevelSplitTree()
    {
        ...
        SplitNode root = new SplitNode(0, 3, 31, splitNode1, splitNode2, 9);
