...
\citeA{Maron98mil} applied multi-instance learning 
...
For example, \citeA{Maron98scene} converted images of natural scenes 
...
Similarly, \citeA{yangPerex} converted each image by dividing the image into 
...
In contrast, \citeA{Zhang2002} used K-means segmentation to obtain 
...
In particular, we consider partitioning the image into a small number 
    ...
    using the datasets created by \citeA{mayomvmi}.
...
\citeA{relaggs} introduced RELAGGS for general relational datasets,
