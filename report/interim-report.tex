...
\begin{center}
        ...
        \end{subfigure}
\end{center}
\caption{Candidate bisections generated for the $\mcl{M}$ corresponding to the example dataset}
\label{visCandGen}
\end{figure}
...
Given a set of candidate bisections $B$ for the labelled set of instances $\mcl{M}_i$, 
    \AdaProp aims to find the optimal bisection $B_i$ in $B$, 
    which is the bisection with the least
